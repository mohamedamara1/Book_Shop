...
@NgModule({
  declarations: [AppComponent, LoginComponent, SignupComponent, GeneralsettingsComponent,
    ...
    ProductComponent, BestSellingComponent, FooterComponent, LeftBarComponent, ProfileSettingsComponent, PaymentInfoComponent, DeleteAccountComponent,ItemComponent,
    BasketComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
